...
function Cart() {
    ...
    const { products, user, axios, currency, cartItems, removeFromCart, getCartAmount, getCartCount, updateCardItems, navigate, setCartItems } = useAppContext()
    ...
    const getUserAddress = async () => {
        try {
            ...
            console.error(" error in  Get Address (axios)", error);
    ...
    const placeOrder = async () => {
        try {
            ...
            console.error(" error in  Place Order (axios)", error);
            if (error.response && error.response.data && error.response.data.message) {
                toast.error(error.response.data.message)
            }
            else {
            ...
            <div className="flex flex-col md:flex-row  mt-16">
                                ...
                                <div>
                                    ...
                                    <div className="font-normal text-gray-500/70">
                                        ...
                                        <div className='flex items-center'>
                                            <p>Qty:</p>
                                            <select onChange={(e) => updateCardItems(product._id, Number(e.target.value))} value={cartItems[product._id]} className='outline-none'>
                ...
                <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative flex justify-between items-start mt-2 flex-wrap">
